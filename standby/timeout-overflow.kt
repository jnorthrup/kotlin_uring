...
fun check_timeout_support(void):Int{
	val __FUNCTION__="check_timeout_support"
    ...
    if (p. features and IORING_FEAT_POLL_32BITS ) {
 ...
 */
fun test_timeout_overflow(void):Int{
	val __FUNCTION__="test_timeout_overflow"
