...
fun test_accept_timeout(do_connect:Int, timeout:ULong ):Int{
	val __FUNCTION__="test_accept_timeout"
    ...
    fast_poll = (p. features and IORING_FEAT_FAST_POLL ) != 0;
