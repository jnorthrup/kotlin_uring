...
static syz_io_uring_submit:Long(volatile a0:Long, volatile a1:Long,
    ...
    sq_array_off:uint32_t =
            (CQ_CQES_OFFSET + SIZEOF_IO_URING_CQE:CPointer<cq_ring_entries> + 63) & ~63;
    if (sq_ring_entries)
...
fun syz_open_dev(volatile a0:Long, volatile a1:Long, volatile a2:Long):Long{
	val __FUNCTION__="syz_open_dev"
