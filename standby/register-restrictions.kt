...
fun test_restrictions_sqe_op(void):Int{
	val __FUNCTION__="test_restrictions_sqe_op"
...
fun test_restrictions_register_op(void):Int{
	val __FUNCTION__="test_restrictions_register_op"
...
fun test_restrictions_fixed_file(void):Int{
	val __FUNCTION__="test_restrictions_fixed_file"
...
fun test_restrictions_flags(void):Int{
	val __FUNCTION__="test_restrictions_flags"
...
fun test_restrictions_empty(void):Int{
	val __FUNCTION__="test_restrictions_empty"
...
fun test_restrictions_rings_not_disabled(void):Int{
	val __FUNCTION__="test_restrictions_rings_not_disabled"
...
fun test_restrictions_rings_disabled(void):Int{
	val __FUNCTION__="test_restrictions_rings_disabled"
