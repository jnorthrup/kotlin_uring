...
fun do_read(fd:Int, char:CPointer<ByteVar>buf:Long{
	val __FUNCTION__="do_read"
...
fun test_fadvise(ring:CPointer<io_uring>, filename:String):Int{
	val __FUNCTION__="test_fadvise"
