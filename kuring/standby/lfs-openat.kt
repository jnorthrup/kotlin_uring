...
fun open_io_uring(ring:CPointer<io_uring>, dfd:Int, fn:String):Int{
	val __FUNCTION__="open_io_uring"
...
fun test_linked_files(dfd:Int, fn:String, async:Boolean):Int{
	val __FUNCTION__="test_linked_files"
...
fun test_drained_files(dfd:Int, fn:String, linked:Boolean, prepend:Boolean):Int{
	val __FUNCTION__="test_drained_files"
