...
static test_update_multiring:Int(r1:CPointer<io_uring>, struct io_uring *r2,
        r3:CPointer<io_uring>, do_unreg:Int) {
    fds:CPointer<Int>, *newfds;
...
fun test_sqe_update(ring:CPointer<io_uring>):Int{
	val __FUNCTION__="test_sqe_update"
