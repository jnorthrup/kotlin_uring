...
static char:CPointer<ByteVar>str= "This is a test of sendmsg and recvmsg over io_uring!";
...
static recv_prep:Int(ring:CPointer<io_uring>, struct iovec *iov, iov_count:Int,
        bgid:Int) {
    saddr:sockaddr_in;
    msg:msghdr;
...
struct recv_data {
    mutex:CPointer<pthread_mutex_t>;
    buf_select:Int;
    no_buf_add:Int;
    iov_count:Int;
};
...
fun recv_fn(void:CPointer<ByteVar>data:CPointer<void>{
    ...
    mutex:CPointer<pthread_mutex_t> = rd.pointed.mutex;
    char buf[MAX_MSG + 1];
...
fun do_sendmsg(void):Int{
	val __FUNCTION__="do_sendmsg"
...
fun test(buf_select:Int, no_buf_add:Int, iov_count:Int):Int{
