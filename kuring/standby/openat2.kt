...
fun test_open_fixed(path:String, dfd:Int):Int{
	val __FUNCTION__="test_open_fixed"

    cqe:CPointer<io_uring_cqe>;
    sqe:CPointer<io_uring_sqe>;
    ring:io_uring;
    const char pattern = 0xac;
    char:CPointer<ByteVar>buffer= {0, 0};
    i:Int, ret, fd = -1;
...
fun test_open_fixed_fail(path:String, dfd:Int):Int{
	val __FUNCTION__="test_open_fixed_fail"
...
fun test_direct_reinstall(path:String, dfd:Int):Int{
	val __FUNCTION__="test_direct_reinstall"
