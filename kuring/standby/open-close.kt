...
fun submit_wait(ring:CPointer<io_uring>):Int{
	val __FUNCTION__="submit_wait"
...
inline try_close:Int(ring:CPointer<io_uring>, fd:Int, slot:Int) {
...
fun test_close_fixed(void):Int{
	val __FUNCTION__="test_close_fixed"
...
fun test_close(ring:CPointer<io_uring>, fd:Int, is_ring_fd:Int):Int{
	val __FUNCTION__="test_close"
...
fun test_openat(ring:CPointer<io_uring>, path:String, dfd:Int):Int{
	val __FUNCTION__="test_openat"
